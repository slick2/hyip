...
$qcash = $mysqli->query("select hc.id as id, hc.cash*$percent as cash, hp.currency as currency, hu.email as email, acc.account as account, hsys.name as name 
...
where acc.account is not null")->fetchAll();
