<form method="GET" action="https://wallet.advcash.com/sci/">
         ...
         <!-- Optional Fields -->
         <input type="hidden" name="ac_success_url" value="http://pa.itinvestproject.com/pay/success" />
         <input type="hidden" name="ac_success_url_method" value="GET" />
         <input type="hidden" name="ac_fail_url" value="http://pa.itinvestproject.com/pay/fail" />
